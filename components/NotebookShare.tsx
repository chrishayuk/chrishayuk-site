 ...
 return <section className="notebook-share social-publishing-kit" id="share">
  ...
  <div className="social-edition-grid">
   <article className="social-edition-panel">
    ...
    <div className="social-edition-heading"><div><p className="record-voice">LINKEDIN / 4:5 / 1200 × 1500</p><h3>LinkedIn</h3></div><a href={assetPath(draft.assets.linkedin.download_url)} download>DOWNLOAD ARTWORK ↓</a></div>
   ...
   <article className="social-edition-panel">
    ...
    <div className="social-edition-heading"><div><p className="record-voice">X / 16:9 / 1600 × 900</p><h3>X</h3></div><a href={assetPath(draft.assets.x.download_url)} download>DOWNLOAD ARTWORK ↓</a></div>
