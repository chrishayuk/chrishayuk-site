    ...
    <div className="notebook-reading">
      <div>
        <article className="notebook-lead" aria-labelledby="notebook-lead-title">
          ...
          <h2 id="notebook-lead-title"><Link href={recordPath(lead)}>{lead.title}</Link></h2>
          <p className="notebook-lead-dek">{lead.dek}</p>
          <Link className="notebook-read" href={recordPath(lead)}>Read the note</Link>
        </article>
        <section id="latest-notes" aria-labelledby="notes-heading"><h2 id="notes-heading" className="notebook-section-label">Recent notes</h2><CompactNotes notes={otherNotes}/></section>
      </div>
