...
export function MachineVisitNotebook({ record }: { record: PublicationRecord }) {
 return <NotebookEntry record={record} className="machine-visit-notebook cinematic-notebook" chapters={[
...
{ label: "Four visits", kind: 'operate', children: <>
...
{ label: "The lost feedback", children: <>
...
{ label: "Describing a visitor", children: <>
