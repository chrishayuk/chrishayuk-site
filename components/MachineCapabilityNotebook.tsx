...
export function MachineCapabilityNotebook({ record }: { record: PublicationRecord }) {
 return <NotebookEntry record={record} className="machine-visit-notebook cinematic-notebook wc-notebook" chapters={[
{ label: "The task", kind: 'operate', children: <>
...
<NotebookNavigation><MachineJourney id={record.id}/><nav className="mv-entry-nav record-voice" aria-label="Explore this note"><a href="#capability-task">TRY THE SIX ROUTES ↑</a><a href="#capability-result">SEE THE RESULT ↑</a><a href="#capability-harness">SWITCH THE CHANNEL ↑</a></nav></NotebookNavigation>
</> }
]}/>;
}
