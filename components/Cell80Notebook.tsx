...
function SurvivalNotebook() {
  return <>
    ...
    <StudyRoom id="cell80-endpoints" label="01 / KEEP THE WORLD POPULATED" title={<>Still alive.<br/><em>Still an open question.</em></>} tone="dark" description="At birth, each eligible program has a 1% or 2% chance of being replaced. Select a world to see which species survived to the end."><Cell80Survival/></StudyRoom>
...
function InventionNotebook() {
  return <>
    <StudyRoom id="cell80-study" label="01 / DOES IT HELP? · EX-10" title={<>A change happened.<br/><em>Eight of them helped.</em></>} tone="dark" description="In this digital world, grazers inherit programs that control their movement. I combined existing programs and replayed 108 births with the new program kept or undone. Then I counted each changed organism’s own offspring.">
      <Cell80Benefits/>
      <div className="cell80-prose"><p><strong>The first result:</strong> eight of the 108 changes produced more offspring in this test. The next question is whether those programs actually do something different.</p></div>
    </StudyRoom>
    ...
    <StudyRoom label="04 / DEPENDENCE" title={<>Would it still help<br/><em>without the first change?</em></>} description="Test all four versions: neither change, the movement change alone, the later setting alone, and both. Select a sequence and a fresh test world to compare their birth counts."><Cell80Dependence/></StudyRoom>
