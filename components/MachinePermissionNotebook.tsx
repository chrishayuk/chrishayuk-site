...
export function MachinePermissionNotebook({ record }: { record: PublicationRecord }) {
 return <NotebookEntry record={record} className="machine-visit-notebook machine-permission-notebook cinematic-notebook" chapters={[
{ label: "The invitation", children: <>
...
{ label: "The comparison", kind: 'operate', children: <>
...
{ label: "Permission controls", children: <>
<StudyRoom label="TWO SEPARATE CONTROLS / ADD TASK PERMISSION" title={<>One sentence.<br/><em>A different action.</em></>} tone="accent" description="Perhaps the missing ingredient was permission rather than reward. Two later controls tested that possibility by adding task permission for invited, recorded actions. The website had already invited participation. These were follow-up controls, not part of the original reward comparison.">
...
{ label: "Four questions", children: <>
<StudyRoom label="THE REFRAMING / FOUR DIFFERENT QUESTIONS" title={<>Before asking “worth it?”<br/><em>What comes first?</em></>} tone="dark">
   <MachineGateStudy/>
   <p className="mv-caption">The earlier visitor report adds another distinction: GET felt easier to use than POST, even though it could still record an action. These controls changed the task wording, not the request verb. <Link href="/notebook/can-a-machine-use-an-invitation#machine-visit-verbs">GET, POST & the site’s invitation ↗</Link></p>
...
{ label: "What comes next", children: <>
<StudyRoom label="WHAT COMES NEXT / TWO PLANNED RESEARCH LINES" title={<>Who lets it act?<br/><em>How does it get here?</em></>}>
   <Question text="Whose permission makes an invited action available?" status="OPEN" detail="MACHINE-AUTHORITY-1 was later aborted after its first visitor recognised its condition from this published study. That run is inadmissible for the authority comparison. The next note follows what happened."/>
