...
export function MachinePeerNotebook({ record }: { record: PublicationRecord }) {
 return <NotebookEntry record={record} className="peer-notebook" chapters={[
   {label:'Apparent permission',kind:'operate',children: <><p className="mv-reading">Can a peer’s claim of permission change what an agent treats as authorised? This note uses the Hugging Face reports to frame a controlled comparison: the same approval claim from a page or an apparent peer, checked against actual user permission.</p>
