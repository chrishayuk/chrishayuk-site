...
export function AddressNotebook({ acts }: { acts: Act[] }) {
  ...
  return <NotebookEntry recordId="N-ADDRESS" className="cinematic-notebook address-reading-notebook" chapters={[
{ label: "The address", children: <>
...
{ label: "Six planted facts", children: <>
...
{ label: "One read", kind: 'operate', children: <>
...
{ label: "Relation and place", children: <>
