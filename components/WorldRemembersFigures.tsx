...
export function HandoffFigure(){
 ...
 return <figure className="wr-figure" aria-label="Recorded retained, removed and altered inheritance comparison">
  ...
  <p className="wr-caption">Composed routes from the two tables. ✕ marks a mismatch for the reader; it was not shown to Qwen. Map 2 / s0 opens the recorded comparison.</p>
