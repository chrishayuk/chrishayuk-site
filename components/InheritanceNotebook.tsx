...
export function InheritanceNotebook({record}:{record:PublicationRecord}) {
 ...
 return <NotebookEntry record={record} className="cinematic-notebook machine-visit-notebook eco-notebook ih-notebook" chapters={[
{ label: "What Sol leaves", children: <>
...
{ label: "Keep or remove", kind: 'operate', children: <>
...
{ label: "A second family", children: <>
...
{ label: "Inheritance and renewal", children: <>
