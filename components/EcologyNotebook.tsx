...
function TransmissionNote({ record }: { record: PublicationRecord }) {
 return <>
  <StudyRoom id="ecology-reminder" label="THE QUESTION / CAN A CONTRIBUTION SPREAD?" title={<>Same past event.<br/><em>One extra sentence.</em></>} description="Qwen could post, but a rewarded example had not made it post more. Perhaps the record of the action mattered instead. Could an example prompt a contribution—and could that contribution become the next agent’s example?">
