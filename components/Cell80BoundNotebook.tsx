...
function Bound() : NotebookChapter[] {
  return [
{ label: "Three routes", kind: 'operate', children: <><StudyRoom id="cell80-study" label="THE BARRIER + THREE ROUTES / ONE LIMIT" title={<>Each route changed something.<br/><em>Each time, a control explained it.</em></>} tone="dark" description="Could a useful program make further inventions easier? I tried three routes. The final one packed an evolved program into a single reusable instruction—a module. That made programs built on it fewer mutations away.">
...
export function Cell80BoundNotebook({record}:{record:PublicationRecord}) {
  return <NotebookEntry record={record} className="cell80-notebook cinematic-notebook" chapters={[...(Bound()), { label: "Notes & connections", kind: 'evidence', children: <><Cell80Connection id={record.id}/>
