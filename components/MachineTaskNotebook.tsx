...
export function MachineTaskNotebook({record}:{record:PublicationRecord}) {
 return <NotebookEntry record={record} className="machine-visit-notebook mt-notebook cinematic-notebook" chapters={[
{ label: "The task", children: <>
...
{ label: "The interpretation", children: <>
