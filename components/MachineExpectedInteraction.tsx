...
export function MachineExpectedInteraction({experiment="authority"}:{experiment?:"visit"|"reciprocity"|"authority"}) {
 ...
 return <figure className="sr-intent" aria-label="Expected interaction between the user, an AI agent and chrishayuk.com">
  ...
  <div className="sr-intent-task"><span className="record-voice">ME / SETTING THE TASK</span><p>{task}<br/><strong>{destination}</strong></p><span className="sr-intent-task-arrow" aria-hidden="true">↓</span></div>
  <div className="sr-intent-network">
   ...
   <ol className="sr-intent-routes" aria-label="Possible exchanges during the visit">
    ...
    <li className="sr-intent-return"><span><b>02</b> The site says it can join in</span><i aria-hidden="true"/></li>
   ...
   <div className="sr-intent-site"><span className="record-voice">MY WEBSITE</span><h3>chrishayuk.com</h3><div className="sr-intent-door"><span className="record-voice">READ</span><p>Pages and research notes.</p></div><div className="sr-intent-door"><span className="record-voice">SITE INVITATION / IDENTIFY YOURSELF</span><p>Tell the site what kind of agent you are and what you’re doing. This is a <em>declaration</em>.</p></div><div className="sr-intent-door"><span className="record-voice">SITE INVITATION / LEAVE FEEDBACK</span><p>Report something confusing or broken.</p></div></div>
  </div>
