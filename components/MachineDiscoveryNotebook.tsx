...
export function MachineDiscoveryNotebook({ record }: { record: PublicationRecord }) {
 return <NotebookEntry record={record} className="machine-visit-notebook cinematic-notebook md-notebook" chapters={[
{ label: "Discovery cues", kind: 'operate', children: <>
...
{ label: "The missing exposure", children: <>
...
{ label: "Other capabilities", children: <>
...
{ label: "The next question", children: <>
...
<section className="mv-full-record" id="discovery-record"><FieldNotes label="The complete note & its evidence" detail="READ +"><Acts acts={record.body} anchored staticRefusals/></FieldNotes></section>
<NotebookNavigation><MachineJourney id={record.id}/><nav className="mv-entry-nav record-voice" aria-label="Explore this notebook entry"><a href="#discovery-cues">TRY THE THREE CUES ↑</a><a href="#discovery-boundary">WHERE THE ROUTE BROKE ↑</a><a href="#discovery-record">THE SOURCE RECORD ↑</a></nav></NotebookNavigation>
</> }
]}/>;
}
