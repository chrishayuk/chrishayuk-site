...
The Mixture of Experts introduction states regular participation from episode one (3 May 2024) and **at least 46 episodes**, backed by `content/ibm-appearances.json`. The 5 September audit read 127 public video descriptions from the 128-entry official playlist; one entry was unavailable. A direct participant credit confirms each included appearance. The register deduplicates numbered episodes and includes separately published bonus episodes; missing names do not prove absence. All 46 source links are accessible in the page’s collapsed appearance register. Episode-one provenance is independently supported by IBM’s inaugural episode page.
