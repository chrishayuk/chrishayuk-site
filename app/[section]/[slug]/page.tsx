...
export async function generateMetadata({params}:Props):Promise<Metadata>{const{section,slug}=await params;const r=getRecord(slug);return{title:section==="film"&&slug==="mixture-of-experts"?"Mixture of Experts":r?.title||"Record not found",description:section==="film"&&slug==="mixture-of-experts"?panelistIntroduction:r?.abstract};}
