...
export default function Page() {
  ...
  return <main id="main" className="thread-page machine-thread programme-page">
    ...
    <ProgrammeIntro name="Machines" question={thread.title}><p>Experiments in finding a tool, recognising what it offers, and deciding whether to use it.</p></ProgrammeIntro>
