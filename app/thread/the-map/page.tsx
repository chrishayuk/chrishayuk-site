...
export default function Page() {
  ...
  return <main id="main" className="thread-page programme-page">
    ...
    <ProgrammeIntro name="Learned Systems" question={thread.title}><p>From the residual map to interventions, addressable memory and the software built around it.</p></ProgrammeIntro>
