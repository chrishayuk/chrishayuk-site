...
export default function Page() {
 ...
 return <main id="main" className="thread-page eco-thread programme-page">
  ...
  <ProgrammeIntro name="Agent Ecology" question={thread.title}><p>Shared records, inherited methods, and what successors do when the world changes.</p></ProgrammeIntro>
