...
export default function Page() {
 ...
 return <main id="main" className="thread-page eco-thread">
  ...
  <div className="thread-ending"><p className="record-voice">THE OPEN QUESTION / WHAT WOULD MAKE THE BENEFIT LAST?</p><h2>A successor used it.<br/><em>Who renews it?</em></h2><p>Sol preserved a supplied record. Qwen and Gemma used the inherited capability but left no next copy. The benefit lasted one successor generation. What intervention would sustain renewal, and would it work in another task world?</p><div className="inline-links"><Link className="text-link" href="/thread/machines">MACHINE EXPERIMENTS / WHEN DOES AN ACTION BELONG TO THE TASK? ↗</Link><Link className="text-link" href="/thread/cell80">CELL80 / WHAT SURVIVES INHERITANCE? ↗</Link></div></div>
 </main>;
}
