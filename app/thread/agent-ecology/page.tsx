...
export default function Page() {
 ...
 return <main id="main" className="thread-page eco-thread">
  ...
  <header className="thread-intro"><p className="kicker record-voice">CHRIS HAY / AGENT ECOLOGY</p><h1>What keeps<br/><em>an action alive?</em></h1><p className="dek">{thread.abstract}</p><p className="thread-context">{thread.context}</p><div className="record-bar record-voice"><a href="#step-1">BEGIN WITH THE BOARD ↓</a><Link href="/thread/machines#field-map">SEE THE FIELD MAP ↗</Link><Link href="/notebook/the-world-can-remember-for-the-agent">EXPLORE THE MEMORY COMPARISON ↗</Link></div></header>
