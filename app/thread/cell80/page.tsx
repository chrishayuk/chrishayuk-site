...
export default function Page() {
  ...
  return <main id="main" className="thread-page cell80-thread">
    ...
    <header className="thread-intro"><p className="kicker record-voice">CHRIS HAY / THE NOTEBOOK / CELL80</p><h1>A world that can<br/><em>be questioned.</em></h1><p className="dek">{thread.abstract}</p><p className="thread-context">{thread.context}</p><div className="record-bar record-voice"><span>SIX CONNECTED NOTES</span><span>WORKING EDITION · V{thread.version}</span><a href="#step-1">BEGIN WITH THE BIRTH ↓</a></div></header>
