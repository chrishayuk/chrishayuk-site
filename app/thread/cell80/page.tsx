...
export default function Page() {
  ...
  return <main id="main" className="thread-page cell80-thread programme-page">
    ...
    <ProgrammeIntro name="Cell80" question="What changes an evolving world?"><p>Replay a birth, follow its descendants, and test which inherited changes matter.</p></ProgrammeIntro>
