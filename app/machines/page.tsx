...
export default async function Page() {
 ...
 return <main id="main" className="publication-main machine-surface machine-exhibition">
  ...
  <section className="me-room"><h2>Does declaring help?</h2><p>The Ask surface retrieves from the public corpus. A declaration can change ranking and framing. It does not unlock more content.</p><p className="record-voice">POST /api/machines/ask</p><p>The third blind visitor judged its declared result worse than anonymous search. The fourth found Ask useful. Two reports across changed revisions are a reason to investigate, not a reliable estimate of the reward.</p><Link className="text-link" href={VISIT_PROTOCOL_PATH}>OPEN THE BLIND-VISITOR EXPERIMENT ↗</Link></section>
