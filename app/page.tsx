...
export default function Home() {
 ...
 const ecologyIntroductions = ["Replay the same world with one inherited change undone.", "Watch predators and grazers, then ask what survival tells us.", "Follow an invention from useful opportunity to inherited change."];
 return <main id="main" className="homepage editorial-home">
  ...
  <section id="from-the-notebook" className="notebook-scene notebook-feature" data-scene="latest-notebook" data-hause-act="connection" aria-labelledby="notebook-feature-heading">
   ...
   {cell80Part(notebook.id) > 0 && <nav className="cell80-home-sequence" aria-label="Read the three Cell80 Notebook entries">
    <div className="cell80-home-sequence-heading"><Kicker>CELL80 / THREE QUESTIONS</Kicker><p>A replayable world. A surviving ecology. An inherited opportunity.</p></div>
