...
export async function GET(_request:Request,{params}:{params:Promise<{id:string}>}){
 ...
 return new ImageResponse(createElement(NotebookSocialCard,{record}),{width:1200,height:630,fonts:[{name:'Geist',data:await textFont,weight:400,style:'normal'},{name:'Fraunces',data:await font,weight:400,style:'normal'}],headers:{'Content-Disposition':'inline'}});
}
