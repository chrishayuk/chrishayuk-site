...
export function llmsDocument(): string {
 const lines: (string | null)[] = [
  ...
  `Published versions preserve the manuscript and source references at /records/{id}/{version}.`,
  `GET /api/record/{id}/history lists change reasons, version links, evidence checksums and citation exports.`,
  `Drafts have no published versions. External references are not archived copies; preserved artifacts carry capture dates.`,
  ``,
  `## Machine visitors`,
  ``,
