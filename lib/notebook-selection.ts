...
const selection = ["N-MACHINE-TASK", "N-MACHINE-SELF-READ", "N-MACHINE-PERMISSION", "N-MACHINE-VISIT", "N-CELL80-01", "N-CELL80-02", "N-CELL80-03", "N-CELL80-BARRIER", "N-CELL80-HISTORY", "N-EXHIBITION", "N-ATTRIBUTION", "N-ADDRESS-BUILD", ...visualNotebooks.map(record => record.id)];
