...
export function recordGraph(){
 ...
 for(const v of allVideos){edges.push({from:v.id,to:v.producer === "IBM"?"COLLECTION-MOE":"CHANNEL-YOUTUBE",kind:"part-of",basis:"source-metadata"});
