...
export const cell80FurtherRecords: PublicationRecord[] = [
  {
    ...
    dek: "Food the existing programs could not use. A combination that could.",
    abstract: "I added food the existing programs could not use, then let mutation combine programs at birth. One combination passed all the food-processing checks. It did not stay common often enough, and the next changes arrived too early for the planned dependence test.",
    lineage: "CELL80 / FURTHER NOTES · EX-11 · THE CAPABILITY BARRIER",
    related: ["N-CELL80-03", "N-CELL80-HISTORY"],
    body: [
      {kind:"observation",label:"THE BARRIER",text:"Organisms in this digital world inherit programs that process food. I added a nutrient the existing programs could not use, then let mutation combine those programs at birth. The experiment asks whether a new combination can use that food.",references:[{label:"Earlier movement experiment",url:"/notebook/when-does-improvement-become-invention"}]},
  ...
  },
  {
    ...
    body: [
      {kind:"observation",label:"AN OPPORTUNITY THAT VANISHED",text:"This world tests two inherited changes: a program that processes new food, and a setting that increases food intake. In EX-12, keeping or undoing them showed that higher intake helped when the program was present. Yet another birth replaced that organism before it reproduced. Its original history ended without offspring.",references:[{label:"How programs evolved to use the new food",url:"/notebook/give-invention-something-to-unlock"}]},
