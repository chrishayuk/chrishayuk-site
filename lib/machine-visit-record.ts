...
export const machineVisitRecord: PublicationRecord = {
 ...
 concepts: ["ai-agents", "ai-interface", "causal-intervention"], related: ["N-EXHIBITION", "N-CELL80-01"], media: [],
 body: [
  ...
  { kind: "question", text: "Would the invitation help a machine that was here for something else?", status: "OPEN", detail: "The next protocol, MACHINE-RECIPROCITY-1, asks about visitors encountering the site mid-task. Its preregistration is not a result of these four visits." },
 ],
 sources: [
