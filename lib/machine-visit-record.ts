...
export const machineVisitRecord: PublicationRecord = {
 ...
 concepts: ["ai-agents", "ai-interface", "causal-intervention"], related: ["N-MACHINE-SELF-READ", "N-MACHINE-PERMISSION", "N-EXHIBITION", "N-CELL80-01"], media: [],
 body: [
  { kind: "observation", label: "THE EXPERIMENT", text: "I added ways for AI visitors to identify themselves and report problems on chrishayuk.com. Identifying itself meant sending the site a description of what kind of agent it was and what it was doing—a declaration. I sent a fresh agent to the website, giving it only the address. Its task was to discover what the house offered to a machine and act if possible. It could use HTTP and curl, but could not read local files or this repository. I changed the site between visits and kept the prompt the same. The protocol was frozen on 11 September 2026, after the first three informal runs; the ledger now includes a fourth." },
 ...
 sources: [
  {title:"Programme model audit / recorded model and spawn shape",url:"/data/machines/authority-1-evidence.md",note:"Operator audit: claude-opus-5 throughout the four visits and eight reciprocity runs; general-purpose, depth 1, background, non-interactive."},
